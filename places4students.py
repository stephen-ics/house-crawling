...
def call_places4students_api(params, cookies):
...
def get_places4students_houses():
    params = {
    ...
    response = call_bamboo_api(params=params, cookies=cookies)
    return response.text

response = get_places4students_houses()
